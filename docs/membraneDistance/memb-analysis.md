# Quantify RNA membrane enrichment with ImJoy
...
can then be pooled together. It contains the following data
    ...
    - `hist_RNA_all_normPix`: normalized RNA histogram with the pixel histogram.
       <img src="https://raw.githubusercontent.com/muellerflorian/locmembrane/master/docs/img/memb_csv.png" width="450px"></img>
-   **Z-i.png**: results of slice 'i'
   <img src="https://raw.githubusercontent.com/muellerflorian/locmembrane/master/docs/img/memb_slicePlot.png" width="600px"></img>
